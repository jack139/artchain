...
import (
	...
	appparams "github.com/jack139/artchain/app/params"
	"github.com/jack139/artchain/x/artchain"
	artchainkeeper "github.com/jack139/artchain/x/artchain/keeper"
	artchaintypes "github.com/jack139/artchain/x/artchain/types"
...
func New(
	...
	//bApp.SetParamStore(app.ParamsKeeper.Subspace(baseapp.Paramspace).WithKeyTable(paramshelper.ConsensusParamsKeyTable()))
	...
	app.artchainKeeper = *artchainkeeper.NewKeeper(
		appCodec, keys[artchaintypes.StoreKey], keys[artchaintypes.MemStoreKey],
	)
...
func (app *App) GetKey(storeKey string) *store.KVStoreKey {
...
//
// NOTE: This is solely to be used for testing purposes.
func (app *App) GetTKey(storeKey string) *store.TransientStoreKey {
...
func (app *App) GetMemKey(storeKey string) *store.MemoryStoreKey {

...
import (
	...
	"github.com/jack139/artchain/x/inventory/client/cli"
	"github.com/jack139/artchain/x/inventory/client/rest"
...
func NewAppModule(cdc codec.Codec, keeper keeper.Keeper, nftKeeper nft.Keeper) AppModule {
	return AppModule{

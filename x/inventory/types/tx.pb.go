...
func (m *MsgCreateReview) GetLastDate() string {
	if m != nil {
		return m.LastDate
	}
	return ""
...
func (m *MsgUpdateReview) GetLastDate() string {
	if m != nil {
		return m.LastDate
	}
	return ""
...
type MsgCreateItem struct {
	...
	AESKey         string `protobuf:"bytes,11,opt,name=AESKey,json=aESKey,proto3" json:"AESKey,omitempty"`
	...
	LastDate       string `protobuf:"bytes,15,opt,name=lastDate,proto3" json:"lastDate,omitempty"`
}
...
func (m *MsgCreateItem) GetLastDate() string {
	if m != nil {
		return m.LastDate
	}
	return ""
...
func (m *MsgUpdateItem) GetLastDate() string {
	if m != nil {
		return m.LastDate
	}
	return ""
...
var fileDescriptor_b129a116e431fe05 = []byte{
	...
	,
}

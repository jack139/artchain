...
var fileDescriptor_9425b12eb6e8692f = []byte{
	...
	0xb1, 0xb8, 0x24, 0x24, 0x33, 0x37, 0x55, 0x82, 0x45, 0x81, 0x51, 0x83, 0x39, 0x88, 0x23, 0x07,
	0xca, 0x17, 0x12, 0xe1, 0x62, 0x0d, 0xc9, 0x2f, 0x49, 0xcc, 0x91, 0x60, 0x05, 0x6b, 0x61, 0x2d,
	0x01, 0x71, 0x9c, 0x5c, 0x4f, 0x3c, 0x92, 0x63, 0xbc, 0xf0, 0x48, 0x8e, 0xf1, 0xc1, 0x23, 0x39,
	0xc6, 0x09, 0x8f, 0xe5, 0x18, 0x2e, 0x3c, 0x96, 0x63, 0xb8, 0xf1, 0x58, 0x8e, 0x21, 0x4a, 0x3b,
	0x3d, 0xb3, 0x24, 0xa3, 0x34, 0x49, 0x2f, 0x39, 0x3f, 0x57, 0x1f, 0xea, 0x25, 0x7d, 0x98, 0x97,
	0xf4, 0x2b, 0xf4, 0x61, 0x7e, 0x2f, 0xa9, 0x2c, 0x48, 0x2d, 0x4e, 0x62, 0x03, 0xfb, 0xc5, 0x18,
	0x10, 0x00, 0x00, 0xff, 0xff, 0x53, 0xeb, 0x99, 0x50, 0x13, 0x01, 0x00, 0x00,
}
...
func (m *Mining) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.LastTime != 0 {
		i = encodeVarintMining(dAtA, i, uint64(m.LastTime))
		i--
		dAtA[i] = 0x20
	}
	if len(m.Minter) > 0 {
...
func (m *Mining) Size() (n int) {
	...
	if m.LastTime != 0 {
		n += 1 + sovMining(uint64(m.LastTime))
	}
	l = len(m.Total)
	if l > 0 {
		n += 1 + l + sovMining(uint64(l))
